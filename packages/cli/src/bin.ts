...
const program = new CLI({
  ...
  examples: [
    ...
    `$ ${CLI_CMD} author create <powerup-name>`,
    `$ ${CLI_CMD} author create <powerup-name> --capture=all`,
    `$ ${CLI_CMD} author create <powerup-name> --capture=workingDir`,
    `$ ${CLI_CMD} author build`,
    `$ ${CLI_CMD} author preview`,
    `$ ${CLI_CMD} author template <outputPath>`,
